...
import { Part, Parts } from "@/pages/employee/edit/service/part/_DEF";
...
export default function PartsManager(props: PartsManagerProps) {
    return (
        <div className="row-start-5 row-span-1 col-start-1 col-span-1 relative flex flex-col grow h-min">
                            ...
                            <td className="p-0 border border-gray-300">
                                ...
                                <div className="px-4 py-4">
                                    <PartDisplay
                                        ...
                                        onDelete={(ID: string) => {
                                            props.partsManager.deleteItem(ID);
            ...
            <SaveResetButtons
                onSave={() => {
                    props.partsManager.saveUpdates();
                    // updateManagerContext.setChangesMade(props.tab, false);
                }}
                onReset={() => {
                    props.partsManager.resetUpdates();
                    // updateManagerContext.setChangesMade(props.tab, false);
                }}
            />
        </div> 
