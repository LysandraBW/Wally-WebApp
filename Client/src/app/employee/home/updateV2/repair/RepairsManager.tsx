...
import { Repair, Repairs } from "@/pages/employee/edit/service/repair/_DEF";
...
export default function RepairsManager(props: RepairsManagerProps) { 
    return (
        <div className="row-start-5 row-span-1 col-start-1 col-span-1 relative flex flex-col grow h-min">
                            ...
                            <td className="p-0 border border-gray-300">
                                ...
                                <div className="px-4 py-4">
                                    <RepairDisplay
                                        ...
                                        onDelete={(ID: string) => {
                                            props.repairsManager.deleteItem(ID);
            ...
            <SaveResetButtons
                onSave={() => {
                    props.repairsManager.saveUpdates();
                    // updateManagerContext.setChangesMade(props.tab, false);
                }}
                onReset={() => {
                    props.repairsManager.resetUpdates();
                    // updateManagerContext.setChangesMade(props.tab, false);
                }}
            />
        </div> 
