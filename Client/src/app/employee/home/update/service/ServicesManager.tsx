...
import ServiceForm from "./ServiceManager";
import useServiceManager from "./useServicesManager";
...
export default function ServicesManager(props: ServicesManagerProps) {
    ...
    return (
        <div className="row-start-5 row-span-1 col-start-1 col-span-1 relative flex flex-col grow h-min">
                            ...
                            <td className="p-0 border border-gray-300">
                                <div className="w-full">
                                    ...
                                    <div className="relative bg-gray-50 flex flex-col gap-0 py-6 px-4  border-b border-b-gray-200">
                                        ...
                                        <CreateItemButton
                                            onCreate={props.servicesManager.openCreateThingForm}
                                        />
                                    </div>
                                </div>
                                <div className="px-4 py-4">
                                    <ServiceDisplay
                                        items={props.servicesManager.newThings}
                                        onUpdate={props.servicesManager.openUpdateThingForm}
                                        onDelete={props.servicesManager.deleteThing}
                                    />
                                    {Object.keys(props.servicesManager.newThings).length <= 0 &&
                                        <div className="bg-gray-5-0 rounded-md h-[100px] flex flex-col justify-center gap-1 things-center justify-center">
            ...
            <SaveResetButtons
                onSave={() => {
                    props.servicesManager.saveUpdates();
                    // updateManagerContext.setChangesMade("Services", false);
                }}
                onReset={() => {
                    props.servicesManager.resetUpdates();
                    // updateManagerContext.setChangesMade("Services", false);
                }}
            />
        </div>
