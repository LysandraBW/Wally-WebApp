...
import { MappedRepairs, Repair } from "./_DEF";


interface RepairsManagerProps {
    thingsManager: ReturnType<typeof useThingsManager<DB_AppointmentRepair, Repair, MappedRepairs>>;
}

export default function RepairManager(props: RepairsManagerProps) {
    return (
