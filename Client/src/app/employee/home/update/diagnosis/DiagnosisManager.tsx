...
import { MappedDiagnoses, Diagnosis } from "./_DEF";
...
interface DiagnosisManagerProps {
    thingsManager: ReturnType<typeof useThingsManager<DB_AppointmentDiagnosis, Diagnosis, MappedDiagnoses>>;
}
        ...
        <div className="row-start-5 row-span-1 col-start-1 col-span-1 relative flex flex-col grow h-min">
            <div className="gap-4 bg-white relative after:absolute after:w-[1px] after:h-full after:top-0 after:left-[0px] after:bg-gray-300 before:absolute before:w-[1px] before:h-full after:top-0 before:right-[0px] before:bg-gray-300 h-full">
                <table className="w-full">
                    <tbody>
                        <tr>
                            <td className="w-0 p-0 text--center bg-white font-medium px-4 text-03 tracking-wide whitespace-nowrap border border-gray-300 align-top pt-2">Diagnoses</td>
                            <td className="p-0 border border-gray-300">
                                ...
                                <div className="px-4 py-4">
                                    <DiagnosisDisplay
                                        ...
                                        onDelete={(ID: string) => {
                                            props.thingsManager.deleteThingByForm(ID);
