...
export default function OpenedTabs(props: OpenedTabsProps) {
    ...
    useEffect(() => {
        setForms(props.tabsManager.tabs.filter((tab: any) => tab.form));
                ...
                >
                    <div
                        className={clsx(
                            ...
                            ((forms.at(0) as any).form.itemID === props.tabsManager.currentTab.form.itemID && (forms.at(0) as any).form.key == props.tabsManager.currentTab.form.key) && "before:rounded-br-md"
                        )}
                    />
                    {forms.map((tab: any, i: number) => {
                                ...
                                >
                                    <div 
                                        className={clsx(
                                            ...
                                            !selected && "rounded-[4px] bg-base-100 dark:bg-base-200 group hover:bg-base-200 dark:hover:bg-base-50 hover:shadow-xs"
                                        )}
                                    >
                                        <span 
                                            className={clsx(
                    ...
                    <div
                        className={clsx(
                            ...
                            ((forms.at(-1) as any).form.itemID === props.tabsManager.currentTab.form.itemID && (forms.at(-1) as any).form.key == props.tabsManager.currentTab.form.key) && "before:rounded-bl-md"
                        )}
                    />
                </div>
                <div 
