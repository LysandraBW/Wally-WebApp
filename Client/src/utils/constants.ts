// These variables are unable to be declared in server files,
// so I am conveniently placing them here.
...
export const HREF_LOOKUP = "/lookup"
export const HREF_SCHEDULE = "/schedule"
export const HREF_EMPLOYEE_LOGIN = "/employee/login"