    ...
    return (
        <button
            ...
            className={clsx(
                ...
                "after:from-white/50 after:to-white/0",
                "dark:after:from-white/30 dark:after:to-white/0",
                ...
                "dark:before:from-[#1F1F1F] dark:before:to-[#141414]",
                props.className,
                props.disabled && `
                    !text-base-400 
                    !cursor-default
                ...
                !props.disabled && `
                    ...
                    hover:after:!from-white/100
                    dark:hover:after:!from-white/20
                    hover:before:!from-base-100 hover:before:!to-base-200
                    dark:hover:before:!from-[#141414] dark:hover:before:!to-base-50
                `
            )}
        >
            {props.children}
