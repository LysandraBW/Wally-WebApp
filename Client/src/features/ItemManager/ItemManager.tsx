            ...
            <AnimatePresence>
                ...
                {((props.tabOpen && itemManager.updateID && props.openFormDisplayed === `Edit ${itemManager.defineItem.itemName}`) || (itemManager.updateID && props.openFormDisplayed === `Edit ${itemManager.defineItem.itemName}`)) &&
                    <motion.div 
                        ...
                        className="w-[400px] border-l border-l-gray-300 row-start-2 row-span-4 col-start-3 col-span-1 border-t- border-t-gray-300 flex grow bg-white relative after:absolute after:w-[1px] after:h-full after:bg-gray-300 after:right-0 after:top-0 !bg-white mb-8 border-b border-b-gray-300"
                    >
                        <props.Form
                            mode="Update"
                            defineItem={props.defineItem}
