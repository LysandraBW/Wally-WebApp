...
export default function ContactForm(props: ContactFormProps) {
    ...
    return (
        <Fragment>
            ...
            {/* <div className="bg-gray-50 w-full h-full border-t border-t-gray-300 relative after:absolute after:w-[1px] after:h-full after:bg-gray-300 after:top-0 after:left-[-1px]"></div> */}
        </Fragment>
    )
}