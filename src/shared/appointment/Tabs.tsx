                ...
                return (
                    <button
                        ...
                        className={clsx(
                            ...
                            !selected && "surface-border bg-base-50 hover:bg-base-200 dark:hover:bg-black dark:bg-base-50 text-base-500 dark:text-base-400 dark:text-base-400",
                            selected && "surface-border bg-base-0 dark:bg-[#121315] text-base-700 font-medium"
                        )}
                    >
