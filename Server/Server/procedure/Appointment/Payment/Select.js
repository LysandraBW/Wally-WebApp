...
export async function execSelectPayments(data) {
    try {
...
export const testSelectPayments = z.object(appointmentKeySchema);

export const selectPayments = {
    test: (input) => testSelectPayments.safeParse(input),
    exec: (input) => execSelectPayments(input)
}